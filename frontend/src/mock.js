export const mockData = {
  ...
  howItWorks: [
    {
      ...
      description: "Analizziamo le opportunità disponibili per la tua azienda e identifichiamo il fondo interprofessionale più adatto alle tue esigenze."
    },
    {
      step: "02",
      title: "Analisi Fabbisogni",
      description: "Individuiamo le reali esigenze formative della tua azienda, anche quelle non esplicite, per massimizzare il valore del progetto."
    },
    {
      step: "03",
      title: "Progettazione Piano",
      description: "Costruiamo il piano formativo completo, conforme ai requisiti dei fondi e ottimizzato per le tue necessità aziendali."
    },
    {
      step: "04",
      title: "Coordinamento Completo",
      description: "Gestiamo tutto il processo coordinando azienda, ente di formazione e docenti, senza alcun impatto organizzativo per te."
    },
    {
      step: "05",
      title: "Erogazione Formazione",
      description: "Organizziamo e supervisioniamo le attività formative garantendo qualità ed efficacia didattica."
    },
    {
      step: "06",
  ...
  services: [
    {
      ...
      description: "Analisi delle opportunità disponibili e scelta del fondo più adatto alla tua realtà aziendale.",
      icon: "briefcase"
    },
    {
      title: "Analisi Fabbisogni Formativi",
      description: "Individuazione delle reali esigenze aziendali, anche quelle non esplicite, per una formazione mirata.",
      icon: "search"
    },
    {
      title: "Progettazione Piani Formativi",
      description: "Costruzione completa del progetto formativo conforme ai requisiti dei fondi interprofessionali.",
      icon: "file-text"
    },
    {
      title: "Gestione Completa del Processo",
      description: "Coordinamento tra azienda, ente di formazione e docenti per un'esperienza senza stress.",
      icon: "users"
    },
    {
      title: "Erogazione e Coordinamento Didattico",
      description: "Organizzazione delle attività formative e supervisione per garantire qualità ed efficacia.",
      icon: "graduation-cap"
    },
    {
      title: "Supporto Amministrativo",
      description: "Preparazione documentazione completa per evitare problemi in fase di controllo/ispezione.",
      icon: "shield-check"
    }
  ],
  ...
  whyChooseUs: [
    {
      ...
      description: "La formazione è completamente finanziata dai fondi interprofessionali. Nessun costo diretto per la tua azienda."
    },
    {
      title: "Gestione Chiavi in Mano",
      description: "Ci occupiamo di tutto il processo dall'analisi alla rendicontazione. Tu ti concentri sul tuo business."
    },
    {
      title: "Esperienza Nazionale",
      description: "Migliaia di ore di formazione erogate e centinaia di aziende servite in tutta Italia."
    },
    {
      title: "Rete Consolidata",
      description: "Collaborazioni con enti di formazione accreditati e una rete di docenti qualificati."
    },
    {
      title: "Conformità Garantita",
      description: "Massima attenzione alla documentazione per evitare problemi in fase ispettiva."
    },
    {
  ...
  caseStudies: [
    {
      ...
      sector: "Settore Metalmeccanico",
      challenge: "Necessità di aggiornamento competenze digitali per 25 dipendenti",
      solution: "Piano formativo su Industria 4.0 e digitalizzazione processi produttivi",
      results: [
        "€45.000 di formazione finanziata",
        "150 ore di formazione erogate",
        "100% di partecipazione dei dipendenti",
        "Zero impatto sui costi aziendali"
      ]
    },
    {
      company: "Struttura Ricettiva - Reggio Calabria",
      sector: "Turismo e Hospitality",
      challenge: "Necessità di formare lo staff su accoglienza turistica, lingue straniere e marketing digitale",
      solution: "Piano formativo su hospitality management, inglese professionale e social media marketing turistico",
      results: [
        "€35.000 di finanziamento ottenuto",
        "120 ore di formazione specialistica",
  ...
  contact: {
    ...
    phone: "+393291747521",
    address: "Reggio Calabria, Italia"
  }
};